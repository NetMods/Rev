...
export const Controls = ({ className, data }) => {
  ...
  return (
    <div className={cn(" px-4 border rounded", className)}>
      <div className="flex items-center justify-center text-sm font-mono space-x-1">
      ...
      <button
        ...
        className="z-50 cursor-pointer p-1 inline-flex items-center justify-center transition-colors"
